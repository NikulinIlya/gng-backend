...
## [Unreleased]
### Added
- AboutInfo, Accessory, Assistant, AssistantPhrase, Brand, Champagne, Cognac, DrinkType, EmployeeOffer, Event, Favorite, GrapeSort, Location, MainPhrase, Offer, Order, OrderStatus, Promotion, UserInfo, Vine, VineColour, Vodka, Whiskey models
