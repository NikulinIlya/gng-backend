...
<head>
    ...
    <style>
        ...
        .deliveryFeedback-options-button:hover .deliveryFeedback-label,
        .deliveryFeedback-options-button:focus .deliveryFeedback-label,
        .deliveryFeedback-options-button:active .deliveryFeedback-label {
            color: #eceeee;
        }
                                    ...
                                    "
                                      ...
                                      "
                                            ...
                                            "
                                                        >
                                            <span
                                            >You can get more information about your order by going to
                                              <a
