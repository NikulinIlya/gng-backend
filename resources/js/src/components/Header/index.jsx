...
const Header = () => {
  ...
  useEffect(
    (_) => {
      if (isMobile)
        document.body.style.position = mobileNavVisibility ? "fixed" : "static";
    },
    [mobileNavVisibility, isMobile]
  );
  return (
    <header className={`header ${mobileNavVisibility ? "header--opened" : ""}`}>
      {!isMobile && <Info />}
          ...
          <div className="header__inner">
            ...
            {!isMobile && (
              <div className="header__render-container">
                ...
                {renderingComponent ? renderingComponent : <SearchInput />}
              </div>
            )}
            <div className="header__nav">
              {!isMobile && (
                <div className="header__nav-item">
                  <Link className="sign-in" to="?login=sign-in">
                    Вход
                  </Link>
                  {"/"}
                  <Link className="sign-up" to="?login=sign-up">
                    Регистрация
                  </Link>
                </div>
              )}
              {isMobile && (
                <div className="header__nav-item nav-item search-handler">
                  <IconButton
                    onClick={(_) =>
                      setMobileSearchVisibility(!mobileSearchVisibility)
                    }
                  >
        ...
        <div className="header__mobile-nav">
          <div className="container">
            <div className="mobile-nav__section">
              ...
              <div className="mobile-nav__item">
                <Link to="/static">Ответственное потребление</Link>
              </div>
              <div className="mobile-nav__item">
          ...
          <div className="container">
            <div className="mobile-nav__section">
              ...
              <div className="mobile-nav__item">
                <Link
                  to="?login=sign-in"
                  onClick={(_) => setMobileNavVisibility(!mobileNavVisibility)}
                >
                  Вход
                </Link>
                /
