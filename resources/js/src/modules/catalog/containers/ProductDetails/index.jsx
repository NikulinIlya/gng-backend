      ...
      <article className="product-details">
        ...
        <section className="product-details__content">
          <div className="product-details__common">
            <h1 className="product-details__name">Cloudy Bay</h1>
            <p className="product-details__descr">
              Sauvignon Blanc, Marlborough, 2014
            </p>
            <p className="product-details__vendor-code">
              Номер товара: 4859066
            </p>
          </div>
          <div className="product-details__features">
            {[
              ...
              { name: "Цвет", value: "Белое", icon: "color" },
              { name: "Крепость", value: "13.5 %", icon: "bottle" },
            ].map((f, i) => (
        ...
        <div className="product-details__about">
          ...
          <div className="product-details__criterias">
            {["Сладость", "Тело", "Кислотность"].map((c, i) => (
            ...
            {[
              ...
              <section className="relative-card" key={i}>
                <div className="relative-card__content">
                  <h3 className="relative-card__title">{r.title}</h3>
                  <p className="relative-card__descr">{r.content}</p>
                </div>
